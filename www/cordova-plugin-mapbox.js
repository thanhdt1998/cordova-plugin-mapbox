...
})(MapEventType || (exports.MapEventType = MapEventType = {}));
...
function setRandomId() {
    return "pmb".concat(Math.floor(Math.random() * Date.now()));
}
...
var getOfflineRegionList = function (styleUrl, _successCallback, _errorCallback) {
    ...
    cordova.exec(successCallback, errorCallback, VIETMAP, Command.GET_OFFLINE_REGION_LIST, [_styleUrl]);
};
...
var deleteOfflineRegion = function (options, _successCallback, _errorCallback) {
    ...
    cordova.exec(successCallback, errorCallback, VIETMAP, Command.DELETE_OFFLINE_REGION, [_options]);
};
...
var setLayoutProperty = function (layerId, property, successCallback, errorCallback) {
    cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_LAYOUT_PROPERTY, [layerId, property]);
};
...
var getPitch = function (resultCallback, errorCallback) {
    cordova.exec(function (value) { return resultCallback(Number(value)); }, errorCallback, VIETMAP, Command.GET_PITCH, []);
};
...
var getZoom = function (resultCallback, errorCallback) {
    cordova.exec(function (value) { return resultCallback(Number(value)); }, errorCallback, VIETMAP, Command.GET_ZOOM, []);
};
...
var getCameraPosition = function (resultCallback, errorCallback) {
    cordova.exec(resultCallback, errorCallback, VIETMAP, Command.GET_CAMERA_POSITION, []);
};
exports.getCameraPosition = getCameraPosition;
var convertCoordinates = function (coords, resultCallback, errorCallback) {
    cordova.exec(resultCallback, errorCallback, VIETMAP, Command.CONVERT_COORDINATES, [coords]);
};
...
var addOnWillStartLoadingMapListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_WILL_START_LOADING_MAP_LISTENER, []);
};
...
var addOnWillStartRenderingMapListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_WILL_START_RENDERING_MAP_LISTENER, []);
};
...
var addOnCameraWillChangeListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_CAMERA_WILL_CHANGE_LISTENER, []);
};
...
var addOnCameraDidChangeListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_CAMERA_DID_CHANGE_LISTENER, []);
};
...
var addOnDidFinishLoadingStyleListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_DID_FINISH_LOADING_STYLE_LISTENER, []);
};
...
var addOnSourceChangedListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_SOURCE_CHANGED_LISTENER, []);
};
...
var addOnWillStartRenderingFrameListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_WILL_START_RENDERING_FRAME_LISTENER, []);
};
...
var addOnDidFinishRenderingFrameListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_DID_FINISH_RENDERING_FRAME_LISTENER, []);
};
...
var addOnDidFinishLoadingMapListener = function (listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_DID_FINISH_LOADING_MAP_LISTENER, []);
};
...
function addOnDidFinishRenderingMapListener(listener, id) {
    if (id === void 0) { id = 0; }
    cordova.exec(listener, null, VIETMAP, Command.ADD_ON_DID_FINISH_RENDERING_MAP_LISTENER, []);
}

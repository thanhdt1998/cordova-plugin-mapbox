...
export type VietmapContainerParams = {
  domContainer: HTMLElement
  additionalDomElements?: HTMLElement[]
}
...
export const show: Vietmap['show'] = function(
  options,
  successCallback,
  errorCallback,
): void {
  ...
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SHOW, [nativeOptions])
}

export const setDebug: Vietmap['setDebug'] = function(
  debug,
  successCallback,
  errorCallback,
): void {
  // Convert value to int
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_DEBUG, [
    Number(debug),
  ])
}

export const setClickable: Vietmap['setClickable'] = function(
  clickable,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_CLICKABLE, [
    clickable,
  ])
}

export const hide: Vietmap['hide'] = function(
  successCallback?: () => void,
  errorCallback?: (e: string) => void,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.HIDE, [])
}

export const destroy: Vietmap['destroy'] = function(
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.DESTROY, [])
}

export const setContainer: Vietmap['setContainer'] = function(
  params,
  successCallback,
  errorCallback,
): void {
  ...
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_CONTAINER, [
    container,
  ])
}

export const downloadRegion: Vietmap['downloadRegion'] = function(
  options,
  statusCallback,
  errorCallback,
): void {
  cordova.exec(statusCallback, errorCallback, VIETMAP, Command.DOWNLOAD_REGION, [
    options,
  ])
}

export const getOfflineRegionList: Vietmap['getOfflineRegionList'] = function(
  styleUrl,
  _successCallback,
  _errorCallback,
...
export const deleteOfflineRegion: Vietmap['deleteOfflineRegion'] = function(
  options,
  _successCallback,
  _errorCallback,
...
export const pauseDownload: Vietmap['pauseDownload'] = function(
  options,
  _successCallback,
  _errorCallback,
): void {
  ...
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.PAUSE_DOWNLOAD, [
    _options,
  ])
}


export const resumeDownload: Vietmap['resumeDownload'] = function(
  options,
  _successCallback,
  _errorCallback,
): void {
  ...
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.RESUME_DOWNLOAD, [
    _options,
  ])
}

export const addMapClickCallback: Vietmap['addMapClickCallback'] = function(
  callback,
  errorCallback,
): void {
  cordova.exec(callback, errorCallback, VIETMAP, Command.ADD_MAP_CLICK_CALLBACK, [
  ])
}

export const deselect: Vietmap['deselect'] = function(
  callback?: () => void,
  errorCallback?: (_e: string) => void,
): void {
  cordova.exec(callback, errorCallback, VIETMAP, Command.DESELECT, [])
}

export const addImage: Vietmap['addImage'] = function(
  imageId,
  image,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.ADD_IMAGE, [
    imageId,
    image,
  ])
}

export const removeImage: Vietmap['removeImage'] = function(
  imageId,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.REMOVE_IMAGE, [
    imageId,
  ])
}

export const addLayer: Vietmap['addLayer'] = function(
  layerObject,
  beforeId,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.ADD_LAYER, [
    layerObject,
    beforeId,
  ])
}

export const setLayoutProperty: Vietmap['setLayoutProperty'] = function(
  layerId,
  property,
  successCallback,
  errorCallback?,
...
export const removeLayer: Vietmap['removeLayer'] = function(
  layerId,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.REMOVE_LAYER, [
    layerId,
  ])
}

export const addSource: Vietmap['addSource'] = function(
  sourceId,
  source,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.ADD_SOURCE, [
    sourceId,
    source,
  ])
}

export const removeSource: Vietmap['removeSource'] = function(
  sourceId,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.REMOVE_SOURCE, [
    sourceId,
  ])
}

export const setGeoJson: Vietmap['setGeoJson'] = function(
  sourceId,
  geoJson,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_GEO_JSON, [
    sourceId,
    geoJson,
  ])
}

export const flyTo: Vietmap['flyTo'] =  function(
  options,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.FLY_TO, [
    options,
  ])
}

export const setCenter: Vietmap['setCenter'] = function(
  center,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_CENTER, [
    center,
  ])
}

export const getCenter: Vietmap['getCenter'] = function(
  resultCallback,
  errorCallback,
): void {
  cordova.exec(resultCallback, errorCallback, VIETMAP, Command.GET_CENTER, [])
}

export const scrollMap: Vietmap['scrollMap'] = function(
  delta: [number, number],
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SCROLL_MAP, [
    delta,
  ])
}

export const setPitch: Vietmap['setPitch'] = function(
  pitch,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_PITCH, [
    pitch,
  ])
}

export const getPitch: Vietmap['getPitch'] = function(
  resultCallback,
  errorCallback,
): void {
  cordova.exec((value: string) => resultCallback(Number(value)), errorCallback, VIETMAP, Command.GET_PITCH, [])
}

export const setZoom: Vietmap['setZoom'] = function(
  zoom,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.SET_ZOOM, [zoom])
}

export const getZoom: Vietmap['getZoom'] = function(
  resultCallback,
  errorCallback,
): void {
  cordova.exec((value: string) => resultCallback(Number(value)), errorCallback, VIETMAP, Command.GET_ZOOM, [])
}

export const zoomTo: Vietmap['zoomTo'] = function(
  zoom,
  successCallback,
  errorCallback,
): void {
  cordova.exec(successCallback, errorCallback, VIETMAP, Command.ZOOM_TO, [zoom])
}

export const getBounds: Vietmap['getBounds'] = function(
  resultCallback,
  errorCallback,
): void {
  cordova.exec(resultCallback, errorCallback, VIETMAP, Command.GET_BOUNDS, [])
}

export const getCameraPosition: Vietmap['getCameraPosition'] = function(
  resultCallback,
  errorCallback,
): void {
  cordova.exec(
...
export const convertCoordinates: Vietmap['convertCoordinates'] = function(
  coords,
  resultCallback,
  errorCallback,
): void {
...
export const convertPoint: Vietmap['convertPoint'] = function(
  point,
  resultCallback,
  errorCallback,
): void {
  cordova.exec(resultCallback, errorCallback, VIETMAP, Command.CONVERT_POINT, [
    point,
  ])
}

export const addOnFlingListener: Vietmap['addOnFlingListener'] = function (listener, id = 0) {
  cordova.exec(listener, null, VIETMAP, Command.ADD_ON_FLING_LISTENER, [])
}

export const addOnMoveListener: Vietmap['addOnMoveListener'] = function (listener, id = 0) {
  cordova.exec(listener, null, VIETMAP, Command.ADD_ON_MOVE_LISTENER, [])
}

export const addOnRotateListener: Vietmap['addOnRotateListener'] = function (listener, id = 0) {
  cordova.exec(listener, null, VIETMAP, Command.ADD_ON_ROTATE_LISTENER, [])
}

export const addOnScaleListener: Vietmap['addOnScaleListener'] = function (listener, id = 0) {
  cordova.exec(listener, null, VIETMAP, Command.ADD_ON_SCALE_LISTENER, [])
}

/**
 * This event is triggered when the map is about to start loading a new map style.
 */
export const addOnWillStartLoadingMapListener: Vietmap['addOnWillStartLoadingMapListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * This event is triggered when the map will start rendering the map.
 */
export const addOnWillStartRenderingMapListener: Vietmap['addOnWillStartRenderingMapListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * This event is triggered whenever the displayed map region is about to change without animation.
 */
export const addOnCameraWillChangeListener: Vietmap['addOnCameraWillChangeListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * This event is triggered whenever the displayed map region finished changing without an animation.
 */
export const addOnCameraDidChangeListener: Vietmap['addOnCameraDidChangeListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * Triggered when a style has finished loading.
 */
export const addOnDidFinishLoadingStyleListener: Vietmap['addOnDidFinishLoadingStyleListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * Triggered when a source changes.
 */
export const addOnSourceChangedListener: Vietmap['addOnSourceChangedListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * This event is triggered when the map will start rendering a frame.
 */
export const addOnWillStartRenderingFrameListener: Vietmap['addOnWillStartRenderingFrameListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * This event is triggered when the map finished rendering a frame.
 */
export const addOnDidFinishRenderingFrameListener: Vietmap['addOnDidFinishRenderingFrameListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
 ...
 * This is triggered when the map has successfully loaded a new map style.
 */
export const addOnDidFinishLoadingMapListener: Vietmap['addOnDidFinishLoadingMapListener'] = function(listener, id = 0) {
  cordova.exec(
    listener,
    null,
    VIETMAP,
